...
Tang, W.\*, **Zhang, L.**\*, & Banerjee, S. On identifiability and consistency of the nugget in Gaussian spatial process models. *Under revision in Journal of the Royal Statistical Society Series B* [arXiv preprint](https://arxiv.org/abs/1908.05726)
...
A Note on using Kullback-Leibler Divergence to compare the performance of some Nearest Neighbor Gaussian Process (NNGP) based models [link](notes/KL-D_com.html) <span class="note">(HTML)</span>
